...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class MapPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference enableClustering = findPreference("enable_shops_clustering");
            final Preference minimumClusterSize = findPreference("minimum_cluster_size");

            enableClustering.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {

                    if (((SwitchPreference)preference).isChecked()) {
                        minimumClusterSize.setEnabled(true);
                    } else {
                        minimumClusterSize.setEnabled(false);
                    }
                    return true;
                }
            });

            bindPreferenceSummaryToValue(findPreference("enable_shops_clustering"));
            bindPreferenceSummaryToValue(findPreference("minimum_cluster_size"));
            bindPreferenceSummaryToValue(findPreference("closing_soon_list"));
        }
    ...
    public static class AboutPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference mailTo = findPreference("pref_send_feedback");
